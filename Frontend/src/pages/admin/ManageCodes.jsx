...
export default function ManageCodes() {
  ...
  const startEdit = (c) => {
    setEditId(c.id);
    setEditForm({ code: c.code, domaineId: c.domaine?.id || "" });
  };
  ...
  return (
    <div className="codes-container">
      ...
      <div className="codes-header">
        ...
        <p className="codes-subtitle">Ajoutez, modifiez et gérez vos codes</p>
      </div>
                  ...
                  <td>
                    {editId === c.id ? (
                      <select
                        ...
                        onChange={(e) =>
                          setEditForm({ ...editForm, domaineId: e.target.value })
                        }
                      >
                      ...
                      <span className="code-domaine">🌐 {c.domaine?.name}</span>
                    )}
                  </td>
                  <td>
                    <span className={`code-status ${c.used ? "used" : "available"}`}>
